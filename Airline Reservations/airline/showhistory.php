...
$sql = "SELECT FL.number AS FLnumber, company, type, time, B.date,  departure, B.ID AS bookid, d_time, arrival, a_time, C.name AS classname, price, paid
...
$rowcount = mysqli_num_rows($result);
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo  '<td> <form action="cancellation.php" method="post">
        ...
        <input type="hidden" name="departute" value="'.$row['departure'].'">
        <input type="hidden" name="arrival" value="'.$row['arrival'].'">
